...
def get_consolidated_data_for_hcp(
    ...
    **CRITICAL:** 
    ...
    completion = client.chat.completions.create(
        model=model_name,
        messages=[
            {"role": "system", "content": "You are a professional medical data researcher. Search the web and return verified data "
            "in structured JSON."},
        ...
        response_format={
            ...
            "json_schema": {
                ...
                "strict": True,
                "schema": to_strict_json_schema(HCPSearchResponse)
            }
        }
    )
    ...
    completion = client.chat.completions.create(
        ...
        response_format={
            ...
            "json_schema": {
                ...
                "strict": True,
                "schema": to_strict_json_schema(HCOSearchResponse)
            }
        }
    )
